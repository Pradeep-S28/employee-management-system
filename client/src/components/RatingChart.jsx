...
// Generic chart card reused for every Task 9 dashboard chart
// (department averages, monthly completed reviews, rating distribution,
// and top performing departments), so we don't repeat the same
// ResponsiveContainer boilerplate four times.
const RatingChart = ({
  title,
  type = "bar",
  data = [],
